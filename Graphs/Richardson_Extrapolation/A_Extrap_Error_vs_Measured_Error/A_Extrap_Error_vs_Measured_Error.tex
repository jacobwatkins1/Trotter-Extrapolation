...
%			log x ticks with fixed point,
			...
			, y= Extrapolated_Error,col sep=comma] {Data/A_Richardson_Extrap_Error_vs_Measured_Error.csv};
			\addplot[ red, mark size=1pt, mark = o, only marks] table[x= Trotter_Depth
			, y= Direct_Measurement_Error,col sep=comma] {Data/A_Richardson_Extrap_Error_vs_Measured_Error.csv};
